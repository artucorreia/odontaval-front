...
import type { SpecialtyPerformanceDatum } from '../../types/semesterDashboard';

interface Props {
  data: SpecialtyPerformanceDatum[];
}

const COLORS = ['#6C5CE7', '#00B894', '#0984E3', '#FDCB6E', '#E17055', '#74B9FF', '#a29bfe'];

export default function SemesterSpecialtyChart({ data }: Props) {
  return (
    <Card
      ...
      {data.length === 0 ? (
        ...
        <ResponsiveContainer width="100%" height={280}>
          ...
          >
            ...
            />
            <Tooltip
              formatter={(value: number, _name: string, props: { payload: SpecialtyPerformanceDatum }) => [
